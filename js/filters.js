...
const sliderElementForm = document.querySelector('.img-upload__effect-level');
...
const updateSlider = () => {
  sliderElementForm.classList.remove('hidden');
  ...
  if (isDefault()) {
    sliderElementForm.classList.add('hidden');
